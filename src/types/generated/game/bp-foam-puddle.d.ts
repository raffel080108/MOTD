declare interface ABP_FoamPuddle_C extends AFoamPuddle {
    readonly __static_ABP_FoamPuddle_C: {
    ...
    readonly __properties_ABP_FoamPuddle_C: {
    ...
    readonly __staticRegistry: 
        ABP_FoamPuddle_C['__static_ABP_FoamPuddle_C'] &
        AFoamPuddle['__staticRegistry'];
    readonly __propertyRegistry: 
        ABP_FoamPuddle_C['__properties_ABP_FoamPuddle_C'] &
        AFoamPuddle['__propertyRegistry'];
}
