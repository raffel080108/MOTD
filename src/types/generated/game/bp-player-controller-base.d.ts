declare interface ABP_PlayerControllerBase_C extends AFSDPlayerController {
    readonly __static_ABP_PlayerControllerBase_C: {
        ...
        GetUnlockedItems(Category: EItemCategory, Unlocked_Items: TSubclassOf<AActor>[]): void;
    ...
    readonly __properties_ABP_PlayerControllerBase_C: {
    ...
    readonly __staticRegistry: 
        ABP_PlayerControllerBase_C['__static_ABP_PlayerControllerBase_C'] &
        AFSDPlayerController['__staticRegistry'];
    readonly __propertyRegistry: 
        ABP_PlayerControllerBase_C['__properties_ABP_PlayerControllerBase_C'] &
        AFSDPlayerController['__propertyRegistry'];
}
