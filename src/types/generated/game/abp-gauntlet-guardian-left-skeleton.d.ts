declare interface UABP_Gauntlet_Guardian_Left_Skeleton_C extends UGuardianGloveAnimInstance {
    readonly __static_UABP_Gauntlet_Guardian_Left_Skeleton_C: {
        AnimGraph(AnimGraph: FPoseLink): void;
    };
    readonly __properties_UABP_Gauntlet_Guardian_Left_Skeleton_C: {
    ...
    readonly __staticRegistry: 
        UABP_Gauntlet_Guardian_Left_Skeleton_C['__static_UABP_Gauntlet_Guardian_Left_Skeleton_C'] &
        UGuardianGloveAnimInstance['__staticRegistry'];
    readonly __propertyRegistry: 
        UABP_Gauntlet_Guardian_Left_Skeleton_C['__properties_UABP_Gauntlet_Guardian_Left_Skeleton_C'] &
