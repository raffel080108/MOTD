declare interface UOptions_Gamepad_EnableQuickSwap_C extends UUserWidget {
    ...
    ExecuteUbergraph_Options_Gamepad_EnableQuickSwap(EntryPoint: number): void;
}
declare const UOptions_Gamepad_EnableQuickSwap_C: UOptions_Gamepad_EnableQuickSwap_C;
