declare interface ABP_FoamPuddle_WalkingPlagueheart_C extends AFoamPuddle_WalkingPlagueheart {
    readonly __static_ABP_FoamPuddle_WalkingPlagueheart_C: {
    ...
    readonly __properties_ABP_FoamPuddle_WalkingPlagueheart_C: {
    ...
    readonly __staticRegistry: 
        ABP_FoamPuddle_WalkingPlagueheart_C['__static_ABP_FoamPuddle_WalkingPlagueheart_C'] &
        AFoamPuddle_WalkingPlagueheart['__staticRegistry'];
    readonly __propertyRegistry: 
        ABP_FoamPuddle_WalkingPlagueheart_C['__properties_ABP_FoamPuddle_WalkingPlagueheart_C'] &
        AFoamPuddle_WalkingPlagueheart['__propertyRegistry'];
}
