declare const enum ERBFKernelType {
    Gaussian = 0,
    Exponential = 1,
    Linear = 2,
    Cubic = 3,
...
declare const enum ERBFQuatDistanceType {
    Euclidean = 0,
    ArcLength = 1,
    SwingAngle = 2,
    TwistAngle = 3
...
declare const enum ERBFVectorDistanceType {
    Euclidean = 0,
    Manhattan = 1,
    ArcLength = 2
}

declare const enum ERigUnitDebugPointMode {
    Point = 0,
    Vector = 1,
    Max = 2
}

declare const enum ERigUnitDebugTransformMode {
    Point = 0,
    Axes = 1,
    Box = 2,
    Max = 3
...
declare const enum ERigUnitVisualDebugPointMode {
    Point = 0,
    Vector = 1,
    Max = 2
}

declare const enum ERigVMAnimEasingType {
    Linear = 0,
    QuadraticEaseIn = 1,
    QuadraticEaseOut = 2,
...
declare const enum ERigVMBreakpointAction {
    None = 0,
    Resume = 1,
    StepOver = 2,
    StepInto = 3,
...
declare const enum ERigVMClampSpatialMode {
    Plane = 0,
    Cylinder = 1,
    Sphere = 2,
    Capsule = 3
...
declare const enum ERigVMCopyType {
    Default = 0,
    FloatToDouble = 1,
    DoubleToFloat = 2
}

declare const enum ERigVMDrawSettings {
    Points = 0,
    Lines = 1,
    LineStrip = 2,
    DynamicMesh = 3
...
declare const enum ERigVMFunctionArgumentDirection {
    Input = 0,
    Output = 1,
    Invalid = 2
}

declare const enum ERigVMMemoryType {
    Work = 0,
    Literal = 1,
    External = 2,
    Debug = 3,
...
declare const enum ERigVMOpCode {
...
declare const enum ERigVMParameterType {
    Input = 0,
    Output = 1,
    Invalid = 2
}

declare const enum ERigVMPinDirection {
    Input = 0,
    Output = 1,
    IO = 2,
    Visible = 3,
...
declare const enum ERigVMRegisterType {
    Plain = 0,
    String = 1,
    Name = 2,
    Struct = 3,
...
declare const enum ERigVMSimPointIntegrateType {
    Verlet = 0,
    SemiExplicitEuler = 1
}

declare const enum ERigVMTransformSpace {
    LocalSpace = 0,
    GlobalSpace = 1,
    Max = 2
}

declare const enum ERigVMUserWorkflowType {
    Invalid = 0,
    NodeContext = 1,
    PinContext = 2,
