declare interface UABP_DropPodMK2_DoorInner_C extends UAnimInstance {
    readonly __static_UABP_DropPodMK2_DoorInner_C: {
        AnimGraph(AnimGraph: FPoseLink): void;
        BlueprintInitializeAnimation(): void;
        BlueprintUpdateAnimation(DeltaTimeX: number): void;
        ExecuteUbergraph_ABP_DropPodMK2_DoorInner(EntryPoint: number): void;
    };
    readonly __properties_UABP_DropPodMK2_DoorInner_C: {
    ...
    readonly __staticRegistry: 
        UABP_DropPodMK2_DoorInner_C['__static_UABP_DropPodMK2_DoorInner_C'] &
        UAnimInstance['__staticRegistry'];
    readonly __propertyRegistry: 
        UABP_DropPodMK2_DoorInner_C['__properties_UABP_DropPodMK2_DoorInner_C'] &
