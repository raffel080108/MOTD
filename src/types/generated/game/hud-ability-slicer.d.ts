declare interface UHUD_Ability_Slicer_C extends UAbilityWidget {
    readonly __static_UHUD_Ability_Slicer_C: {
    ...
    readonly __properties_UHUD_Ability_Slicer_C: {
    ...
    readonly __staticRegistry: 
        UHUD_Ability_Slicer_C['__static_UHUD_Ability_Slicer_C'] &
        UAbilityWidget['__staticRegistry'];
    readonly __propertyRegistry: 
        UHUD_Ability_Slicer_C['__properties_UHUD_Ability_Slicer_C'] &
