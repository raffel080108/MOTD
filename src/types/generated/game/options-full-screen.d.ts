declare interface UOptions_FullScreen_C extends UUserWidget {
    ...
    ExecuteUbergraph_Options_FullScreen(EntryPoint: number): void;
}
declare const UOptions_FullScreen_C: UOptions_FullScreen_C;
