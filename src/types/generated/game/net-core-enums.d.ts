declare const enum EFastArraySerializerDeltaFlags {
    None = 0,
    HasBeenSerialized = 1,
...
declare const enum ENetCloseResult {
...
declare const enum ENetworkFailure {
    NetDriverAlreadyExists = 0,
    NetDriverCreateFailure = 1,
    NetDriverListenFailure = 2,
    ConnectionLost = 3,
...
declare const enum EReplicationSystem {
    Default = 0,
    Generic = 1,
    Iris = 2
}
