declare const enum EDataSortTypeEnum {
...
declare const enum EDataSourceTypeEnum {
...
declare const enum EDebugTypeEnum {
...
declare const enum ELocationYToSpawnEnum {
...
declare const enum ELocationZToSpawnEnum {
...
declare const enum ENDIGeometryCollection_SourceMode {
    Default = 0,
    Source = 1,
    AttachParent = 2,
...
declare const enum ERandomVelocityGenerationTypeEnum {
