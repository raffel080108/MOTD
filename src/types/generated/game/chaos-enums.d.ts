declare const enum ChaosDeformableSimSpace {
    World = 0,
    ComponentXf = 1,
    bone = 2
}

declare const enum EAllowConvexMergeMethod {
    ByProximity = 0,
    Any = 1
}

declare const enum EChaosBufferMode {
    Double = 0,
    Triple = 1,
    Num = 2,
    Invalid = 3
...
declare const enum EChaosSoftsSimulationSpace {
    WorldSpace = 0,
    ComponentSpace = 1,
    ReferenceBoneSpace = 2
}

declare const enum EChaosSolverTickMode {
    Fixed = 0,
    Variable = 1,
    VariableCapped = 2,
...
declare const enum EChaosThreadingMode {
    DedicatedThread = 0,
    TaskGraph = 1,
    SingleThread = 2,
    Num = 3,
...
declare const enum EClusterUnionMethod {
    PointImplicit = 0,
...
declare const enum ECollisionTypeEnum {
    Chaos_Volumetric = 0,
    Chaos_Surface_Volumetric = 1,
    Chaos_Max = 2
}

declare const enum EConnectionContactMethod {
    None = 0,
    ConvexHullContactArea = 1
}

declare const enum EConvexHullProximityFilter {
    None = 0,
    BoundingBox = 1
}

declare const enum EConvexOverlapRemoval {
    None = 0,
    All = 1,
    OnlyClusters = 2,
...
declare const enum EDamageModelTypeEnum {
    Chaos_Damage_Model_UserDefined_Damage_Threshold = 0,
    Chaos_Damage_Model_Material_Strength_And_Connectivity_DamageThreshold = 1,
    Chaos_Max = 2
}

declare const enum EEmissionPatternTypeEnum {
    Chaos_Emission_Pattern_First_Frame = 0,
    Chaos_Emission_Pattern_On_Demand = 1,
    Chaos_Max = 2
}

declare const enum EFieldCullingOperationType {
    Field_Culling_Inside = 0,
    Field_Culling_Outside = 1,
    Field_Culling_Operation_Max = 2
}

declare const enum EFieldFalloffType {
...
declare const enum EFieldFilterType {
...
declare const enum EFieldIntegerType {
...
declare const enum EFieldObjectType {
...
declare const enum EFieldOperationType {
    Field_Multiply = 0,
    Field_Divide = 1,
    Field_Add = 2,
    Field_Substract = 3,
...
declare const enum EFieldOutputType {
...
declare const enum EFieldPhysicsDefaultFields {
...
declare const enum EFieldPhysicsType {
    Field_None = 0,
...
declare const enum EFieldPositionType {
    Field_Position_CenterOfMass = 0,
    Field_Position_PivotPoint = 1,
    Field_Position_Max = 2
}

declare const enum EFieldResolutionType {
...
declare const enum EFieldScalarType {
...
declare const enum EFieldVectorType {
...
declare const enum EGenerateConvexMethod {
    ExternalCollision = 0,
    ComputedFromGeometry = 1,
    IntersectExternalWithComputed = 2
}

declare const enum EGeometryCollectionCacheType {
    None = 0,
    Record = 1,
    Play = 2,
    RecordAndPlay = 3
...
declare const enum EGeometryCollectionPhysicsTypeEnum {
...
declare const enum EImplicitTypeEnum {
...
declare const enum EInitialVelocityTypeEnum {
    Chaos_Initial_Velocity_User_Defined = 0,
    Chaos_Initial_Velocity_None = 1,
    Chaos_Max = 2
}

declare const enum EObjectStateTypeEnum {
    Chaos_NONE = 0,
...
declare const enum EProximityContactMethod {
    MinOverlapInProjectionToMajorAxes = 0,
    ConvexHullSharpContact = 1,
    ConvexHullAreaContact = 2
}

declare const enum EProximityMethod {
    Precise = 0,
    ConvexHull = 1
}

declare const enum ESetMaskConditionType {
    Field_Set_Always = 0,
...
declare const enum EWaveFunctionType {
    Field_Wave_Cosine = 0,
