declare const enum ERaDistanceRolloffModel {
    LOGARITHMIC = 0,
    LINEAR = 1,
    NONE = 2
}

declare const enum ERaMaterialName {
    TRANSPARENT = 0,
...
declare const enum ERaQualityMode {
    STEREO_PANNING = 0,
    BINAURAL_LOW = 1,
    BINAURAL_MEDIUM = 2,
    BINAURAL_HIGH = 3
...
declare const enum ERaSpatializationMethod {
    STEREO_PANNING = 0,
    HRTF = 1
}

declare const enum EResonanceRenderMode {
    StereoPanning = 0,
