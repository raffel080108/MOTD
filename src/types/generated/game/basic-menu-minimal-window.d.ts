declare interface UBasic_Menu_MinimalWindow_C extends UUserWidget {
    readonly __static_UBasic_Menu_MinimalWindow_C: {
    ...
    readonly __properties_UBasic_Menu_MinimalWindow_C: {
    ...
    readonly __staticRegistry: 
        UBasic_Menu_MinimalWindow_C['__static_UBasic_Menu_MinimalWindow_C'] &
        UUserWidget['__staticRegistry'];
    readonly __propertyRegistry: 
        UBasic_Menu_MinimalWindow_C['__properties_UBasic_Menu_MinimalWindow_C'] &
