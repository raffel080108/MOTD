declare interface UABP_DropPodMK2_DoorOuter_C extends UAnimInstance {
    readonly __static_UABP_DropPodMK2_DoorOuter_C: {
        AnimGraph(AnimGraph: FPoseLink): void;
        BlueprintInitializeAnimation(): void;
        BlueprintUpdateAnimation(DeltaTimeX: number): void;
        ExecuteUbergraph_ABP_DropPodMK2_DoorOuter(EntryPoint: number): void;
    };
    readonly __properties_UABP_DropPodMK2_DoorOuter_C: {
        AnimBlueprintClassConstantData: {
        __NameProperty_47: string;
        __NameProperty_48: string;
    ...
    readonly __staticRegistry: 
        UABP_DropPodMK2_DoorOuter_C['__static_UABP_DropPodMK2_DoorOuter_C'] &
        UAnimInstance['__staticRegistry'];
    readonly __propertyRegistry: 
        UABP_DropPodMK2_DoorOuter_C['__properties_UABP_DropPodMK2_DoorOuter_C'] &
