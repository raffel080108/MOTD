declare interface UOptions_EnableCritSound_C extends UUserWidget {
    ...
    ExecuteUbergraph_Options_EnableCritSound(EntryPoint: number): void;
}
declare const UOptions_EnableCritSound_C: UOptions_EnableCritSound_C;
