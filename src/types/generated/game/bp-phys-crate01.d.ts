declare interface ABP_Phys_Crate01_C extends AActor {
    ...
    ExecuteUbergraph_BP_Phys_Crate01(EntryPoint: number): void;
}
declare const ABP_Phys_Crate01_C: ABP_Phys_Crate01_C;
