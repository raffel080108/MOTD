declare interface UITEM_SpaceRig_TeamMember_C extends UUserWidget {
    readonly __static_UITEM_SpaceRig_TeamMember_C: {
        SetPlayerName(): void;
    ...
    readonly __properties_UITEM_SpaceRig_TeamMember_C: {
    ...
    readonly __staticRegistry: 
        UITEM_SpaceRig_TeamMember_C['__static_UITEM_SpaceRig_TeamMember_C'] &
        UUserWidget['__staticRegistry'];
    readonly __propertyRegistry: 
        UITEM_SpaceRig_TeamMember_C['__properties_UITEM_SpaceRig_TeamMember_C'] &
