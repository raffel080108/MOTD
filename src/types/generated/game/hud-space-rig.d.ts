declare interface UHUD_SpaceRig_C extends URamrodHUDWidget {
    readonly __static_UHUD_SpaceRig_C: {
        Construct(): void;
    ...
    readonly __properties_UHUD_SpaceRig_C: {
    ...
    readonly __staticRegistry: 
        UHUD_SpaceRig_C['__static_UHUD_SpaceRig_C'] &
        URamrodHUDWidget['__staticRegistry'];
    readonly __propertyRegistry: 
        UHUD_SpaceRig_C['__properties_UHUD_SpaceRig_C'] &
        URamrodHUDWidget['__propertyRegistry'];
}
