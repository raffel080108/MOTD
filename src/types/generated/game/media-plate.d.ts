...
declare interface UMediaPlateComponent extends UActorComponent {
    readonly __static_UMediaPlateComponent: {
        ...
        SelectExternalMedia(InFilePath: string): void;
    ...
    readonly __properties_UMediaPlateComponent: {
        bPlayOnOpen: boolean;
        bAutoPlay: boolean;
        ...
        StaticMeshComponent: UStaticMeshComponent;
        Letterboxes: UStaticMeshComponent[];
    ...
    readonly __staticRegistry: 
        UMediaPlateComponent['__static_UMediaPlateComponent'] &
        UActorComponent['__staticRegistry'];
    readonly __propertyRegistry: 
        UMediaPlateComponent['__properties_UMediaPlateComponent'] &
