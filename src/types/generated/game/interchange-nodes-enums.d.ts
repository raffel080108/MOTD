declare const enum EInterchangeAnimatedProperty {
    None = 0,
    Visibility = 1,
    MAX = 2
}

declare const enum EInterchangeAnimationPayLoadType {
    NONE = 0,
    CURVE = 1,
    MORPHTARGETCURVE = 2,
    STEPCURVE = 3,
...
declare const enum EInterchangeCameraProjectionType {
    Perspective = 0,
    Orthographic = 1
}

declare const enum EInterchangeLightUnits {
    Unitless = 0,
    Candelas = 1,
    Lumens = 2,
    EV = 3
...
declare const enum EInterchangeMeshCollision {
    Box = 0,
    Sphere = 1,
    Capsule = 2,
    Convex10DOP_X = 3,
...
declare const enum EInterchangeMeshPayLoadType {
    NONE = 0,
    STATIC = 1,
    SKELETAL = 2,
    MORPHTARGET = 3,
...
declare const enum EInterchangeMotionVectorsHandling {
    NoMotionVectors = 0,
    ImportVelocitiesAsMotionVectors = 1,
    CalculateMotionVectorsDuringImport = 2
}

declare const enum EInterchangePropertyTracks {
...
declare const enum EInterchangeTextureColorSpace {
    TCS_None = 0,
    TCS_sRGB = 1,
    TCS_Rec2020 = 2,
    TCS_ACESAP0 = 3,
...
declare const enum EInterchangeTextureFilterMode {
    Nearest = 0,
    Bilinear = 1,
    Trilinear = 2,
    Default = 3
...
declare const enum EInterchangeTextureWrapMode {
    Wrap = 0,
    Clamp = 1,
    Mirror = 2
}

declare const enum EVolumeGridElementType {
    Unknown = 0,
    Half = 1,
    Float = 2,
    Double = 3
