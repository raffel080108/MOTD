declare interface UABP_DropPodMK2_DoorMid_C extends UAnimInstance {
    readonly __static_UABP_DropPodMK2_DoorMid_C: {
    ...
    readonly __properties_UABP_DropPodMK2_DoorMid_C: {
    ...
    readonly __staticRegistry: 
        UABP_DropPodMK2_DoorMid_C['__static_UABP_DropPodMK2_DoorMid_C'] &
        UAnimInstance['__staticRegistry'];
    readonly __propertyRegistry: 
        UABP_DropPodMK2_DoorMid_C['__properties_UABP_DropPodMK2_DoorMid_C'] &
